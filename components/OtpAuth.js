 ...
 return (
    <SafeAreaView style={styles.container}>
      <ScrollView>
                    ...
                    <View>
                            <Text style={styles.text}>Please Insert the OTP Received on</Text>
                    </View>

                    {/* Financial Store below text */}
                    <View>
                            <Text style={styles.second_text}>Your Mobile No/Email Id</Text>
                    </View>

                    {/* OTP Input Field */}
                    <View style={{marginLeft:70,marginTop:50}}>
